...
// Direct3D 12 中的许多结构体都有其对应的扩展辅助结构变体（variation），考虑到使用上的方便性，
// 我们更偏爱于运用那些变体。以 CD3DX12 作为前缀的变体全都定义在 d3dx12.h 头文件当中，
// 这个文件并不属于 DirectX 12 SDK 的核心部分，但是可以通过微软的官方网站下载获得。
